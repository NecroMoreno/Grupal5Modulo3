-- Trabajo grupal 5, Módulo 3, Grupo 2.
...
Parte 6: Creen una nueva tabla llamada Contactos (id_contacto, id_usuario, numero de teléfono, 
correo electrónico). 
...
- 
El tiempo máximo para resolver la evaluación es el periodo correspondiente a una clase 
regular. 
- 
